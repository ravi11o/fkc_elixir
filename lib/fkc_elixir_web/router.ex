defmodule FkcElixirWeb.Router do
  use FkcElixirWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {FkcElixirWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: FkcElixirWeb.Telemetry
    end
  end
